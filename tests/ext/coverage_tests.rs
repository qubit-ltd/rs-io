...
mod coverage_tests {
    ...
    use qubit_io::{
        Input, Output, ReadExt, Streams, coverage_add_item_count_overflow,
        coverage_fail_next_add_item_count, coverage_fail_next_reserve,
        coverage_fail_next_string_reserve, coverage_fail_reserve_above,
        coverage_fail_reserve_after, coverage_reset_add_item_count_hooks,
    ...
    fn test_streams_reports_copied_item_count_overflow() {
        let error =
            coverage_add_item_count_overflow().expect_err("copied item count overflow should fail");
    ...
    fn test_streams_copy_input_to_output_at_most_reports_add_item_count_overflow() {
        ...
        let error = Streams::copy_input_to_output_at_most(&mut input, &mut output, 3)
            .expect_err("bounded copy should propagate copied item count overflow");
    ...
    fn test_streams_copy_input_to_output_end_limited_reports_add_item_count_overflow() {
        ...
        let error = Streams::copy_input_to_output_end_limited(&mut input, &mut output, 3)
            .expect_err("end-limited copy should propagate copied item count overflow");
    ...
    fn test_streams_compare_content_reports_second_buffer_allocation_failure() {
        ...
        let error = Streams::compare_content_with_buffer_size(&mut left, &mut right, 4)
            .expect_err("compare should propagate second buffer allocation failures");
    ...
    fn test_input_ext_copy_to_at_most_reports_create_vec_allocation_failure() {
        ...
        coverage_fail_next_reserve();
        let error = Streams::copy_input_to_output_at_most(&mut input, &mut output, 2)
            .expect_err("bounded copy should propagate buffer allocation failures");
    ...
    fn test_copy_input_to_output_at_most_bounds_temporary_buffer() {
        ...
        let result = Streams::copy_input_to_output_at_most(&mut input, &mut output, 1);
        reset_coverage_hooks();
        let copied = result.expect("one-item copy should allocate one temporary item");
    ...
    fn test_input_ext_copy_to_end_limited_reports_create_vec_allocation_failure() {
        ...
        coverage_fail_next_reserve();
        let error = Streams::copy_input_to_output_end_limited(&mut input, &mut output, 3)
            .expect_err("end-limited copy should propagate buffer allocation failures");
    ...
    fn test_copy_input_to_output_end_limited_bounds_temporary_buffer() {
        ...
        coverage_fail_reserve_above(1);
        let result = Streams::copy_input_to_output_end_limited(&mut input, &mut output, 0);
        reset_coverage_hooks();
        let copied = result.expect("zero-item limit should allocate one probe item");
    ...
    fn test_read_ext_read_to_end_limited_reports_initial_reserve_failure() {
        ...
        coverage_fail_next_reserve();
        let error = reader
            .read_to_end_limited(8)
            .expect_err("read_to_end_limited should propagate reserve failures");
    ...
    fn test_read_ext_read_to_end_limited_into_rolls_back_on_reserve_failure() {
        ...
        coverage_fail_next_reserve();
        let error = reader
            .read_to_end_limited_into(&mut output, 8)
            .expect_err("read_to_end_limited_into should propagate reserve failures");
